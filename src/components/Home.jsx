...
const Home = () => {
    var name = "Abderrahmane Bouhir 22 ans"
        ...
        <section className="col-span-1 w-full h-full my-9 md:my-[10%] lg:mt-[6%] flex flex-col items-center md:items-center  space-y-10 mb-28 md:mb-0 relative"  >
            ...
            <div className="inline md:flex md:flex-row-reverse md:items-center md:justify-around">
                <div className=" w-[75%] h-[350px] md:w-[360px]  relative flex justify-center  ">
                    ...
                    <div className="absolute bottom-14 ml-2 ">
                        <img className="w-[360px] h-[460px]  max-w-screen-sm md:hidden" src={mobileImage} alt="My" />
                        <img className="w-[360px] h-[460px]  max-w-screen-sm hidden md:inline " src={desktopImage} alt="My" />
            ...
            <div className="w-full lg:w-[70%] flex flex-col items-center md:flex-row-reverse md:flex-wrap md:justify-around   ">
                ...
                <div className="self-center">
                    <Item nombre={2} status={"Expériences"} color={"item-secondary"} ellipseColor="border-secondary shadow-ellipse-secondary" />
                </div>
            </div>
